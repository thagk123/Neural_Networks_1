...
print(f"Ακρίβεια k-NN με k=1 στο test set: {accuracy_knn_k1*100}%")
print(f"Ακρίβεια k-NN με k=3 στο test set: {accuracy_knn_k3*100}%")
print(f"Ακρίβεια k-NN με k=1 στο training set: {accuracy_knn_train_k1*100}%")
print(f"Ακρίβεια k-NN με k=3 στο training set: {accuracy_knn_train_k3*100}%")
print(f"Ακρίβεια NCC στο test set: {accuracy_nearest_centroid*100}%")
print(f"Ακρίβεια NCC στο training set: {accuracy_nearest_centroid_train*100}%")
